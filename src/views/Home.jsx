    ...
    <div className="flex justify-center flex-col items-center bg-stone-100">
      ...
      >
        ...
        <div className=" absolute bottom-36 text-center md:static lg:static text-nowrap flex flex-col">
          ...
          <p className="text-xs  w-[340px] px-5 text-pretty animate-slide-in-right transform duration-3000 ">
      ...
      <section id="portfolio" className="lg:w-full md:w-[440px] flex justify-center flex-col items-center z-30 bg-stone-950">
        ...
        <div className="relative w-full overflow-hidden">
          <div className="flex transition-transform duration-300 ease-in-out" style={{ transform: `translateX(-${currentIndex * 100}%)` }}>
            {images.map((image, index) => (
              <div key={index} className="carousel-slide relative w-full flex-shrink-0">
                <img src={image} alt={`image${index + 1}`} className="object-cover h-[500px] w-full" />
                <div className="absolute inset-0 bg-gradient-to-b from-lime-50/70 to-stone-950/70 bg-opacity-50 flex flex-col items-center justify-center opacity-0 hover:opacity-100 transition-opacity duration-300">
                  <div className="absolute bottom-10 flex flex-col justify-center items-center">
                    <p className="text-stone-50 font-bold text-center text-xl text-pretty">NOMBRE PROJECTO</p>
                    <a>
          ...
          <button className="absolute top-1/2 left-0 transform -translate-y-1/2 bg-stone-50 text-lime-500 p-2 rounded-full z-10" onClick={prevSlide}>
            &lt;
          </button>
          <button className="absolute top-1/2 right-0 transform -translate-y-1/2 bg-stone-50 text-lime-500 p-2 rounded-full z-10" onClick={nextSlide}>
            &gt;
          </button>
        </div>
        <a>
      ...
      <section id="blogs" className="w-[340px] lg:w-full md:w-[440px] flex justify-center flex-col items-center z-30">
