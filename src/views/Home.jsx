  ...
  return (
    <div className="flex justify-center flex-col items-center bg-stone-100">
      ...
      >
        ...
        />
        <div className="absolute bottom-0 text-center md:static lg:static lg:text-nowrap flex justify-center flex-col items-center" style={{ textShadow: '1px 1px 2px rgba(0, 0, 0, 0.3)' }}>
          ...
          <p className="text-pretty animate-slide-in-right transform duration-3000 w-[340px] lg:w-[740px] text-center  text-stone-950 mb-10">
